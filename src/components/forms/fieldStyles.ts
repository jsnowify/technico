...
export const FIELD_CLASSES =
  "mt-2 w-full border border-white/20 bg-black-bg px-4 py-3.5 text-white-text placeholder:text-content-muted transition-colors focus-visible:border-accent focus-visible:bg-accent-surface focus-visible:outline-none";
...
export const LABEL_CLASSES = "block text-sm font-medium text-content";

export const FIELDSET_CLASSES = "m-0 min-w-0 border-0 p-0";

export const GROUP_LABEL_CLASSES =
  "mb-8 block w-full p-0 font-mono text-xs tracking-[0.08em] text-accent uppercase";

/** Dropdown/panel shell shared by every custom picker. */
export const POPOVER_PANEL_CLASSES =
  "absolute z-30 mt-2 w-full overflow-hidden border border-white/20 bg-black-bg shadow-[0_20px_45px_rgba(0,0,0,0.5)]";
...
export const OPTION_INACTIVE_CLASSES = "hover:bg-accent-surface";

export const OPTION_ACTIVE_CLASSES = "bg-accent-surface";

export const OPTION_SELECTED_CLASSES = "bg-accent text-black-bg";
...
export const CHIP_BASE_CLASSES =
  "border px-4 py-2.5 text-sm font-medium text-center transition-colors";
...
export const TAG_BASE_CLASSES =
  "border px-4 py-2.5 text-sm font-medium text-left leading-snug transition-colors";

export const CHIP_INACTIVE_CLASSES =
  "border-white/20 text-content hover:border-accent hover:bg-accent-surface";

export const CHIP_ACTIVE_CLASSES = "border-accent bg-accent text-black-bg";

    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        <RevealText
          ...
          lines={["Systems", "built to", "grow."]}
        />

        <div
          data-reveal-stagger
          className="mt-20 grid gap-px overflow-hidden bg-white/20 md:grid-cols-2 lg:grid-cols-4"
        >
          {/* real service items go here once you share them */}
        </div>
      </div>
    </section>
  );
